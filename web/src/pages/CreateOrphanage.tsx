...
export default function CreateOrphanage() {
  ...
  function handleSelectImage(event: ChangeEvent<HTMLInputElement>) {
    ...
    const selectedImagesPreview = selectedImages.map(imagesPreview => {
      return URL.createObjectURL(imagesPreview)
    })
        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          ...
          <fieldset>
            ...
            <div className="input-block">
              ...
              <textarea id="instructions" value={instruction} onChange={e => setInstruction(e.target.value)} />
            </div>
